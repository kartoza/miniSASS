                  ...
                  <div>
                    ...
                    <div className="flex flex-row h-[46px] md:h-auto items-start justify-start w-auto">
                      ...
                      <div className="flex flex-row items-center justify-start w-[97%] sm:w-full">
                        <Field as="select" name="siteName" className="!text-black-900_99 font-raleway text-base text-left"
                            placeholderClassName="!text-black-900_99"
                            placeholder=""
                            shape="round"
                            color="black_900_3a"
                          ...
                          >
                          {sites.map((option) => (
                            <option key={option.value} value={option.value} selected={option.value === values.siteName}>
                              {option.label}
                            </option>
                          ))}
                        </Field>
