  ...
  return (
    <div ref={ref}>
      ...
      <button
        ...
        } relative w-full border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none sm:text-sm`}
        aria-haspopup="listbox"
        aria-expanded="true"
        aria-labelledby="listbox-label"
        style={{
            backgroundColor: disabled ? "#f0f0f0" : "white",
            border: `1px solid ${selected ? "#539987" : "gray"}`, // Green when selected, gray when not
            borderRadius: "4px",
        ...
        onClick={onToggle}
        disabled={disabled}
        onMouseEnter={() => setSelected(true)} // Set the border to green when the mouse enters
        onMouseLeave={() => setSelected(false)} // Revert the border when the mouse leaves
        >
        ...
        <AnimatePresence>
          {open && (
            <motion.ul
              ...
              style={{
                borderColor: selected ? "#539987" : "gray", // Set the border color here
              }}
            >
