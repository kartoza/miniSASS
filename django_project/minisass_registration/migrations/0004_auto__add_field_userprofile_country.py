...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('minisass_registration_userprofile', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='country_lookup', null=True, to=orm['minisass_registration.Lookup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.country'
        db.delete_column('minisass_registration_userprofile', 'country_id')
    ...
    models = {
        ...
        'minisass_registration.userprofile': {
            ...
            'country': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'country_lookup'", 'null': 'True', 'to': "orm['minisass_registration.Lookup']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
