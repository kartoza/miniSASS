...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ObservationPlugin.observation'
        db.delete_column('cmsplugin_observationplugin', 'observation_id')
        ...
        db.add_column(u'sites', 'time_stamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2013, 4, 29, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ObservationPlugin.observation'
        raise RuntimeError("Cannot reverse this migration. 'ObservationPlugin.observation' and its values cannot be restored.")
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 29, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
