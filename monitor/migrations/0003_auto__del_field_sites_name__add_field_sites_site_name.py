...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sites.name'
        db.delete_column(u'sites', 'name')

        # Adding field 'Sites.site_name'
        db.add_column(u'sites', 'site_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Sites.name'
        db.add_column(u'sites', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'Sites.site_name'
        db.delete_column(u'sites', 'site_name')
