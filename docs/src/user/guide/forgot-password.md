...
![login form](./img/forgot-change-password-1.png)
...
![forgot password form](./img/forgot-change-password-2.png)

On successful submission the success message will be displayed.

![forgot password form](./img/forgot-change-password-3.png)
...
![reset password email](./img/forgot-change-password-4.png)
...
![update password form](./img/forgot-change-password-5.png)
...
![update password form](./img/forgot-change-password-6.png)
